...
png("plot4.png")
par(mfrow = c(2,2))
plot(table$datetime, table[,3], type="l", ylab = "Global Active Power", xlab = "")
plot(table$datetime, table[,5], type="l", ylab = "Voltage", xlab = "datetime")
...
plot(table$datetime, table[,4], type="l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
